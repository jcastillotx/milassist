...
const icons = {
  ...
  // Finance & Money
  invoice: (
    <path d="M9 7h6m-6 4h6m-6 4h4m5-10v14a2 2 0 01-2 2H8a2 2 0 01-2-2V5a2 2 0 012-2h6l4 4z" />
  ),
  money: (
  ...
  // Documents & Files
  document: (
    <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zm-2 1v5h5" />
  ),
  form: (
    <>
  ...
  // Travel & Calendar
  travel: (
    <path d="M21 16v-2a4 4 0 00-4-4H7a4 4 0 00-4 4v2M17.8 2.8L16 7H8L6.2 2.8M12 7v4M7 12h10M7.5 12L9 22h6l1.5-10" />
  ),
  plane: (
    <path d="M21 16v-2a4 4 0 00-4-4H7l-4 4 4 4h10a4 4 0 004-4zM7 10V4l3-2M17 10V4l-3-2" />
  ),
  calendar: (
    <>
  ...
  headset: (
    <>
      ...
      <path d="M19 21v1a2 2 0 01-2 2h-4" />
    </>
  ),
  microsoft: (
    <>
  ...
  scale: (
    <>
      <path d="M12 3v18M5 8l7-5 7 5M5 8v4l7 3 7-3V8" />
    </>
  ),
  book: (
    <path d="M4 19.5A2.5 2.5 0 016.5 17H20M4 19.5A2.5 2.5 0 016.5 17H20M4 4.5A2.5 2.5 0 016.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15z" />
  ),
  briefcase: (
    <>
  ...
  party: (
    <>
      ...
      <path d="M4 3h.01M22 8h.01M15 2h.01M22 20h.01M22 2l-2.24.75a4 4 0 00-2.67 2.67L16 8a4 4 0 01-2.67 2.67L10 11.5l3 3 .75-3.33a4 4 0 012.67-2.67L22 6" />
    </>
  ),
  logout: (
    <>
